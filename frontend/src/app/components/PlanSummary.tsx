import { CheckCircle2, AlertTriangle, Calendar, Users, DollarSign, FileCheck } from 'lucide-react';
import { engagementPlanSummary } from '../data/mockData';
import type { RiskLevel } from '../types/audit';

export function PlanSummary() {
  const plan = engagementPlanSummary;
